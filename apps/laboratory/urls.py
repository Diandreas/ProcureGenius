...
from .views_pdf import LabResultPDFView, LabReferenceCatalogPDFView
...
urlpatterns = [
    ...
    path('tests/reference-catalog/', LabReferenceCatalogPDFView.as_view(), name='reference-catalog-pdf'),
