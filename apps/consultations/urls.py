...
urlpatterns = [
    ...
    path('consultations/', api.ConsultationListCreateView.as_view(), name='consultation-list'),
    path('consultations/<uuid:pk>/', api.ConsultationDetailView.as_view(), name='consultation-detail'),
    path('consultations/<uuid:pk>/vitals/', api.UpdateVitalSignsView.as_view(), name='update-vitals'),
    path('consultations/<uuid:pk>/end/', api.EndConsultationView.as_view(), name='end-consultation'),
    path('consultations/today/', api.TodayConsultationsView.as_view(), name='today-consultations'),
