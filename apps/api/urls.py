...
urlpatterns = [
    ...
    path('accounts/permission-catalog/', accounts_api_views.api_permission_catalog, name='api_permission_catalog'),
    ...
    path('healthcare/patients/', include('apps.patients.urls')),
