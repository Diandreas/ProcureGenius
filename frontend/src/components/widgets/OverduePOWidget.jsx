...
const OverduePOWidget = ({ period = 'last_30_days' }) => {
  ...
  if (!data || !data.purchase_orders) return <div className="widget-empty"><AlertTriangle size={40} className="widget-empty-icon" /><div className="widget-empty-text">Aucun BC en retard</div></div>;
