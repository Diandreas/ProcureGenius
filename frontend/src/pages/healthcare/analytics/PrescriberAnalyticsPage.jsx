                                        ...
                                        {data.by_prescriber.length === 0 ? (
                                            ...
                                            data.by_prescriber.map(row => (
                                                <TableRow key={row.prescriber_id} hover>
                                                    ...
                                                    <TableCell align="right">
                                                        {row.pricing_mode === 'subcontract' ? (
                                                            <Chip label="Sous-traitant" size="small" color="info" variant="outlined" />
                                                    ...
                                                    <TableCell align="right">
                                                        <Typography
                                                            variant="body2"
                                                            fontWeight={700}
                                                            color={row.pricing_mode === 'subcontract' ? 'text.disabled' : 'warning.main'}
                                                        >
