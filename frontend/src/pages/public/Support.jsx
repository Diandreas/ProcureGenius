...
import { Box, Container, Typography, Paper, Grid, useTheme, Button, alpha } from '@mui/material';
import { Email, WhatsApp, YouTube, SupportAgent } from '@mui/icons-material';
...
export default function PublicSupport() {
  ...
  return (
    <Box sx={{ width: '100%', py: { xs: 8, md: 12 }, position: 'relative' }}>
      {/* Decorative Blur Background mapping from Landing logic */}
          ...
          <Grid item xs={12} md={6}>
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.1 }}>
              <Paper sx={{ 
                ...
                boxShadow: isDark ? 'none' : '0 20px 40px rgba(0,0,0,0.04)',
                '&:hover': { borderColor: '#2563eb', transform: 'translateY(-4px)' },
                ...
                <Button 
                  href="mailto:report.makeitreal@gmail.com" 
                  variant="outlined" 
                  fullWidth
                  size="large"
