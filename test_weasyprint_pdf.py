"""
Script de test pour vérifier que WeasyPrint fonctionne correctement
"""
import os
import django
...
def test_weasyprint():
    """Teste la génération de PDF avec WeasyPrint"""

    print("\n" + "="*60)
    print("TEST DE GENERATION PDF AVEC WEASYPRINT")
    print("="*60 + "\n")
    ...
    try:
        ...
        for template_type in templates:
            ...
            try:
                ...
                # Sauvegarder le PDF
                filename = f'test_weasyprint_{template_type}.pdf'
        ...
        print("  - test_weasyprint_classic.pdf")
        print("  - test_weasyprint_modern.pdf")
        print("  - test_weasyprint_minimal.pdf")
        print("\nLes PDFs devraient contenir un QR code en bas de page.")
